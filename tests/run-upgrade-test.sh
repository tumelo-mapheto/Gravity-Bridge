...
docker run --name gravity_all_up_test_instance $PLATFORM_CMD --cap-add=NET_ADMIN $PORTS -it gravity-base /bin/bash /gravity/tests/container-scripts/upgrade-test-internal.sh $NODES $OLD_VERSION
